...
<style lang="less" scoped>
	...
	.content-gm{
		...
		.contentBg{
			...
			height: 414/@rem;
			background-size: cover;
			.animation(moveScale, @t: 3s, @fn: ease-in-out, @delay: 1s, @i: 1,@dur: alternate) ;
		...
		.content-item{
			...
			height: 76/@rem;
			opacity: 0;
			.animation(fadeIn, @t: 1.5s, @fn: ease-in-out, @delay:2.5s, @i: 1,@dur: alternate) ;
			                animation-fill-mode: forwards; 
			img{
				display: block;
				width: 100%;
